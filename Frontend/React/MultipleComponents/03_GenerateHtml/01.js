/*
Generera HTML-kod utifrån JavaScript

+ Använda samma HTML, ingen duplicering av HTML-kod

- SEO: google ser inte dina taggar
- Kan vara svårt att designa
- Svårt att lägga in saker mellan två komponenter
...
function initEmailComponents() {
    ...
    document.body.innerHTML = (emailHtml + "<h1>En rubrik</h1>"+  emailHtml+ emailHtml)
